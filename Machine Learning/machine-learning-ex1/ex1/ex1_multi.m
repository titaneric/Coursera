...
theta = zeros(3, 1);
[theta0, J0] = gradientDescentMulti(X, y, theta, alpha0, num_iters);
...
figure;
plot(1:50, J0(1:50), 'g', 'LineWidth', 2);
hold on;
...
test_data = [1650, 3]; % You should change this
[test_data mu sigma] = featureNormalize(test_data);
test_data = [1 test_data];
price = test_data * theta1;
